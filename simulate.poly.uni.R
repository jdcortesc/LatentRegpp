...
simulate.poly.uni = function (n = 1000, nitems = 10, ncatgs = c(rep(3, 5), rep(4, 5)), model = "grm", seed_item = 1000,seed_data=2000) 
{
  thetas = list()
  umbrales = list()
  disc=list()
...
# simm=simulate.poly.uni(n = 1000,nitems = 30,ncatgs = rep(2,30),model = "grm")
# simm$params.it
